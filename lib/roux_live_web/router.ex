defmodule RouxLiveWeb.Router do
  use RouxLiveWeb, :router

  pipeline :browser do
    plug :accepts, ["html"]
    plug :fetch_session
    plug :fetch_live_flash
    plug :put_root_layout, html: {RouxLiveWeb.Layouts, :root}
  ...
  if Application.compile_env(:roux_live, :dev_routes) do
    ...
    scope "/dev" do
      ...
      live_dashboard "/dashboard", metrics: RouxLiveWeb.Telemetry
